...
<style scoped>
.note {display:flex;flex-flow:column;height:100vh;}
.toolbar {margin-bottom:3px;}
.toolbar button {border:0;border-radius: 5px;background-color:#ddd;padding:6px 10px;}
.title {width:100%;box-sizing: border-box;border:0;border-bottom:1px solid #e3e3e3;font-size:30px; outline:0;padding:15px;margin-bottom:10px;}
.note .body {border:0;padding:15px;height:100%;overflow:auto;}
</style>
